...
# open the logo image
logo = Image.open("C:/Users/HP/Downloads/GradScope Logo.png")
...
if st.session_state["show_reason"]:
    ...
    if gre_score < average_values['gre']:
        st.write(f"**{student_name}!** Your GRE score ({gre_score}) is below average. Consider improving it to at least {average_values['gre']}.")
    ...
    if toefl_score < average_values['toefl']:
        st.write(f"**{student_name}!** Your TOEFL score ({toefl_score}) is below average. Consider improving it to at least {average_values['toefl']}.")
    ...
    if sop_score < average_values['sop']:
        st.write(f"**{student_name}!** Your SOP score ({sop_score}) is below average. Consider improving it to at least {average_values['sop']}.")
    ...
    if lor_score < average_values['lor']:
        st.write(f"**{student_name}!** Your LOR score ({lor_score}) is below average. Consider improving it to at least {average_values['lor']}.")
    ...
    if cgpa_score < average_values['cgpa']:
        st.write(f"**{student_name}!** Unfortunately, you can't improve your cgpa as you've already graduated")
    ...
    if Research != average_values['research']:
        st.write(f"**{student_name}!** You stand a better chance if you have some research experience.")
